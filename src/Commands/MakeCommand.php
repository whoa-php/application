...
class MakeCommand implements CommandInterface
{
     ...
     * Command name.
     */
    public const NAME = 'w:make';

    /** Argument name */
    public const ARG_ITEM = 'item';

    /** Argument name */
    public const ARG_SINGULAR = 'singular';

    /** Argument name */
    public const ARG_PLURAL = 'plural';

    /** Command action */
    public const ITEM_DATA_RESOURCE = 'data-resource';

    /** Command action */
    public const ITEM_WEB_RESOURCE = 'web-resource';

    /** Command action */
    public const ITEM_JSON_API_RESOURCE = 'json-resource';

    /** Command action */
    public const ITEM_FULL_RESOURCE = 'resource';
    ...
    private function filterOutFolderMask(string $folder): string
    {
        ...
        return str_replace($mask, '', $folder);
    }
}
