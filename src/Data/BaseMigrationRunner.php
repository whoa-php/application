...
abstract class BaseMigrationRunner
{
    ...
    public const MIGRATIONS_TABLE = '_migrations';

    /** Migration column name */
    public const MIGRATIONS_COLUMN_ID = 'id';

    /** Migration column name */
    public const MIGRATIONS_COLUMN_CLASS = 'class';

    /** Migration column name */
    public const MIGRATIONS_COLUMN_MIGRATED_AT = 'migrated_at';

    /** Seeds table name */
    public const SEEDS_TABLE = '_seeds';

    /**
     * @var IoInterface
     */
    private IoInterface $inOut;
